...
public class VideoPlayView extends SurfaceView implements MediaPlayerControl
{
	...
	private Uri mUri;//播放地址
	private int mDuration;

	// All the stuff we need for playing and showing a video
	private SurfaceHolder mSurfaceHolder = null;
	private IjkExoMediaPlayer mMediaPlayer = null;
...
//			mMediaPlayer.reset();
	...
	{
		public void onVideoSizeChanged(IMediaPlayer mp, int width, int height, int pw, int ph)
		{
...
//			System.out.println("加载完成");
			if (!(String.valueOf(mUri).startsWith("http")))
			{
				System.out.println("本地播放:"+String.valueOf(mUri));
//				HashMap<String, Object> vHashMap = Dao.getEncryKey(videoUrl);
//				if(vHashMap.size()==0)
//				{
//					FileEnDecryptManager.encryption(String.valueOf(mUri),videoUrl,videoName);
//				}
			}
			else
			{
				System.out.println("网络播放:"+String.valueOf(mUri));
			}
		}
	};
...
//			try
//			{
//				mMediaPlayer.prepare();可以解决代码38错误问题
